	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord27 = IN.ase_texcoord3.xy * _PixelsValue + float2( 0,0 );
				float2 texCoord2 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_0 = (texCoord2.y).xx;
				float2 panner6 = ( _TimeParameters.x * float2( 0,2 ) + temp_cast_0);
				...
				float2 texCoord21 = IN.ase_texcoord3.xy * float2( 1,1 ) + ( simplePerlin2D11 * appendResult31 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( tex2D( _pixels, texCoord27 ) * 0.3 ) + ( tex2D( _Poster, texCoord21 ) * 2.0 ) ).rgb;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-1643.465,596.8922;Inherit;False;Property;_NoiseValue;NoiseValue;4;0;Create;True;0;0;0;False;0;False;0.3;0.03;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;31;-1355.761,547.4292;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;21;-918.8115,261.3441;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;23;-167.4069,306.3003;Inherit;True;Property;_Poster;Poster;0;0;Create;True;0;0;0;False;0;False;-1;None;2b6444ce61b221d4f925480cebe79b36;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7F914977F04EA86DD173A52ADE49B44A4210EAA0